...
if(isset($_POST['signup']))
{
	...
	$msg=$db_handle->runQuery_default("insert into users(fname,lname,email,password,contactno) values('$fname','$lname','$email','$enc_password','$contact')");
if($msg)
{
...
$num= $db_handle->runQuery_Array("SELECT * FROM users WHERE email='$useremail' and password='$enc_password'"); 
if($num>0)
{
$extra="welcome.php";
...
$row1=$db_handle->runQuery_Array("select email,password from users where email='$femail'"); 
if($row1>0)
{
$email = $row1['email'];
...
<div class="main">
     <h1><div class="pageTitle">Registration and Login System</div></h1>
	 <div class="sap_tabs">	
